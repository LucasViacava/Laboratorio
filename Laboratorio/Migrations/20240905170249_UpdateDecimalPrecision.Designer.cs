...
namespace Laboratorio.Migrations
{
    ...
    [Migration("20240905170249_UpdateDecimalPrecision")]
            ...
            modelBuilder.Entity("Laboratorio.Entities.Comanda", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTimeOffset(new DateTime(2024, 9, 5, 14, 2, 48, 836, DateTimeKind.Unspecified).AddTicks(5343), new TimeSpan(0, -3, 0, 0, 0)),
                            MenuItemId = 1,
                            Pedido = "",
                            PedidoId = 1
                        },
                        new
                        {
                            ...
                            Cantidad = 2,
                            Estado = "En Preparación",
                            FechaCreacion = new DateTimeOffset(new DateTime(2024, 9, 5, 14, 2, 48, 836, DateTimeKind.Unspecified).AddTicks(5365), new TimeSpan(0, -3, 0, 0, 0)),
                            MenuItemId = 2,
                            Pedido = "",
                            PedidoId = 1
                        },
                        new
                        {
                            ...
                            Cantidad = 1,
                            Estado = "En Preparación",
                            FechaCreacion = new DateTimeOffset(new DateTime(2024, 9, 5, 14, 2, 48, 836, DateTimeKind.Unspecified).AddTicks(5368), new TimeSpan(0, -3, 0, 0, 0)),
                            MenuItemId = 3,
                            Pedido = "",
                            PedidoId = 1
                        },
                        new
                        {
                            ...
                            Cantidad = 1,
                            Estado = "En Preparación",
                            FechaCreacion = new DateTimeOffset(new DateTime(2024, 9, 5, 14, 2, 48, 836, DateTimeKind.Unspecified).AddTicks(5370), new TimeSpan(0, -3, 0, 0, 0)),
                            MenuItemId = 4,
                            Pedido = "",
                            PedidoId = 1
                        });
